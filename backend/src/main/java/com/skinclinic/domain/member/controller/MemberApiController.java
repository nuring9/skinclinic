...
public class MemberApiController {
    ...
    public ResponseEntity<?> sendSignupEmailCode(@RequestBody Map<String, String> request) {
        memberService.sendEmailCode(request.get("email"));
        return ResponseEntity.ok(Map.of("message", "인증번호가 이메일로 전송되었습니다."));
    }

    @PostMapping("/email/verify")
    public ResponseEntity<?> verifySignupEmailCode(@RequestBody EmailVerifyDto dto) {
